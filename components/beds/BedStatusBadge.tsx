...
export function BedStatusBadge({ status, showIcon = true }: BedStatusBadgeProps) {
  ...
  return (
    <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-semibold shadow-sm ${config.color}`}>
